...
const pages = [
  ...
  },
  {
    ...
    showLocation: 'DOWNLOADS_HUB',
    displayOrder: 2,
    metaTitle: 'Useful Documents & Reference Material',
    metaDescription: 'Download essential reference documents, notes, formulas and study materials.',
    isPublished: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
    downloadItems: [
