...
export const metadata: Metadata = {
  title: "Daily Current Affairs for BPSC in Hindi & English | Final Attempt IAS",
  ...
  openGraph: {
    title: "BPSC Daily Current Affairs | Final Attempt IAS",
    description: "Daily current affairs in Hindi & English for BPSC, UPSC and Bihar PCS aspirants from Final Attempt IAS.",
