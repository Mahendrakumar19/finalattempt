...
export const testSeriesData: TestSeriesItem[] = [
  {
    ...
    batchStartDate: '10 September 2026',
    enrolledCount: 1840,
    validityDays: 180,
    isPublished: true,
    displayOrder: 1,
  ...
  {
    id: 'bpsc-prelims-pyq-test-series-2026',
    title: 'BPSC Prelims PYQ Test Series 2026',
    slug: 'bpsc-prelims-pyq-test-series-2026',
    category: 'Prelims',
    exam: 'BPSC',
    examId: '5cb632ed-d17d-4f2d-af21-8d5374782f5e',
    language: 'Hindi',
    status: 'active',
    thumbnailUrl: 'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&fit=crop&q=80&w=600',
    bannerUrl: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=1200',
    ...
    description: 'Comprehensive BPSC Prelims Previous Year Questions Test Series with bilingual solutions.',
    highlights: [
      '40 Comprehensive PYQ Mock Tests',
      'Detailed Subject Specialist Explanations',
      'Instant Diagnostic Radar & Rank'
    ],
    syllabus: [],
    faq: [],
    batchStartDate: '10 September 2026',
