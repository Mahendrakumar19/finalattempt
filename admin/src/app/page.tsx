  ...
  if (!adminToken) {
    return (
      <div className="min-h-screen bg-white text-black flex items-center justify-center p-4">
        <form onSubmit={handleAdminLogin} className="w-full max-w-sm border border-slate-200 p-8 rounded-3xl space-y-6 shadow-xl bg-white">
          <div className="text-center space-y-2">
            <div className="inline-flex w-12 h-12 rounded-2xl bg-red-650 items-center justify-center font-extrabold text-lg text-white shadow-md">
              FA
            </div>
            <h2 className="text-xl font-heading font-extrabold text-slate-900 mt-2">Admin CMS Console</h2>
            <p className="text-xs text-slate-500 font-medium">Please sign in with administrator credentials</p>
          </div>

          {authError && (
            <div className="p-3 text-xs bg-red-50 text-red-650 border border-red-200 rounded-xl font-semibold text-center">
              {authError}
            </div>
          )}
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 text-slate-900 text-xs rounded-xl focus:outline-none focus:border-red-500 placeholder-slate-400"
              />
            </div>

            <div className="space-y-1.5">
              <label className="text-[10px] text-slate-450 font-bold uppercase tracking-wider">Password</label>
              <input
                type="password"
                required
                value={adminPassword}
          ...
          <button
            type="submit"
            className="w-full py-3 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl text-xs shadow-md transition-transform hover:scale-[1.01]"
          >
            Authenticate Access
          </button>
        </form>
                    ...
                    <div className="flex justify-between items-start gap-4">
                      ...
                      <div className="flex gap-2">
                        <button 
                          ...
                          className="p-1.5 bg-slate-50 border border-slate-200 rounded-lg hover:bg-slate-100 text-slate-650"
                        >
                          <Edit3 className="w-3.5 h-3.5" />
                        </button>
                        <button 
                          ...
                          className="p-1.5 bg-red-50 border border-red-200 rounded-lg hover:bg-red-600 hover:text-white text-red-500 transition-colors"
                        >
                          <Trash2 className="w-3.5 h-3.5" />
                        </button>
                      </div>
                ...
                <form onSubmit={async (e) => {
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-2 bg-slate-50 border border-slate-200 text-slate-900 text-xs rounded-xl focus:outline-none focus:border-red-500 disabled:opacity-50"
                    />
                  </div>
